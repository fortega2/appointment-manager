...
// RouteTemplate returns the matched route template as a bounded label value,
...
// It is exported so the OpenTelemetry span name and this package's request
// metrics derive their route from one implementation.
