...
COMMENT ON COLUMN public.slot.start_time IS 'The start time of the slot with timezone information.';
COMMENT ON COLUMN public.slot.end_time IS 'The end time of the slot with timezone information.';
