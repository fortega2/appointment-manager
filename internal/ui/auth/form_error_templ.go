...
// FormError is the error message htmx swaps into an auth form. It brings no
// markup of its own, so each form styles the slot it lands in.
func FormError(message string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/auth/form_error.templ`, Line: 6, Col: 16}
		}
